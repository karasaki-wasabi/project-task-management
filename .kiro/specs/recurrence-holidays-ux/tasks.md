...
- [x] 7. Core: 繰り返し設定画面と休日マスタ画面の分離・UX
- [x] 7.1 (P) 繰り返しテンプレの Form/Detail Modal を案件連動のみ・確定デザインに更新する
...
- [x] 7.3 /recurrence ページをテンプレ専用一覧に刷新し、休日 UI と固定間隔操作を除去する
...
- [x] 9. 適用・TX・候補一致・UI 主要経路の横断回帰を通す
