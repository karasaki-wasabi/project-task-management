...
- **Adjacent expectations**
  ...
  - 既存データの整合と終端段階の初期投入は、手書きマイグレーション・seed・ワークスペース作成の各経路で行う（詳細は design.md）
...
9. When メンバーが新しいワークスペースを作成した場合、the System shall 当該ワークスペースに完了種別と中止種別の開発段階をそれぞれちょうど 1 つずつ用意する
