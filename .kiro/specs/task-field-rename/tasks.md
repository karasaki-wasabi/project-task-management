...
- [x] 5. フロントエンド: API 境界と画面文言
- [x] 5.1 (P) API クライアントの型と呼び出しを新識別名へ揃える
...
- [x] 5.2 (P) タスク詳細モーダルと一覧作成フォームの文言を揃える
...
- [x] 5.3 (P) 繰り返しテンプレート画面の既定詳細文言を揃える
...
- [x] 5.4 (P) カレンダーの終了予定日参照を新プロパティ名へ揃える
