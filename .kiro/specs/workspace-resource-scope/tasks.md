...
- [x] 1. Foundation: 共有ヘルパー・ガード・スキーマ移行
...
- [x] 3. Core: タスクのワークスペーススコープ化と担当者検証
...
- [x] 4. Core: 繰り返しタスクテンプレートのワークスペーススコープ化
...
- [x] 9.2 作成時のワークスペース指定がクライアント入力で上書きされないことを検証する
  - タスク・案件の作成リクエストで、本文中にワークスペースを示す値を紛れ込ませても、実際に帰属するワークスペースは現在ワークスペースの文脈から決まる値になることを確認する
  - 観測可能な完了状態: 上記の検証テストがgreenになる
  - _Requirements: 1.1, 1.2_
  - _Depends: 2.1, 3.1_

- [x] 10. Validation: E2Eによるワークスペース分離の確認
- [x] 10.1 既存E2Eのワークスペース前提を共有fixtureに切り出す
